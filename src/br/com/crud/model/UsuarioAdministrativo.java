...
public class UsuarioAdministrativo extends Usuario implements Serializable {
    ...
    public UsuarioAdministrativo(String nome, String email, String senha, Integer permissao) {
        super(nome, email, senha, permissao);
        this.permissoes = new ArrayList<>();
    }

    public UsuarioAdministrativo(Integer id, String nome, String email, String senha, Integer permissao) {
    ...
    public boolean equals(Object o) {
        ...
        UsuarioAdministrativo that = (UsuarioAdministrativo) o;
